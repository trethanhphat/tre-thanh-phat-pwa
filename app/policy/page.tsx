  ...
  return (
    <main className="main">
      ...
      <ul>
        ...
        <li>
          <b>Mục đích sử dụng:</b> Cải thiện dịch vụ, cá nhân hóa trải nghiệm người dùng, gửi thông
          báo liên quan.
        </li>
        <li>
      ...
      <hr />
      <h3>2. Chính sách sử dụng</h3>
      <p>Khi sử dụng ứng dụng {appName}, bạn đồng ý tuân theo các điều khoản sau:</p>
      <ul>
      ...
      <ul>
        ...
        <li>
          <b>Mục đích xử lý:</b> Chỉ sử dụng để cung cấp dịch vụ tốt hơn.
        </li>
        <li>
          <b>Bảo vệ dữ liệu:</b> Áp dụng mã hoá, phân quyền truy cập, xác thực 2 lớp (nếu có).
        </li>
        <li>
          <b>Khiếu nại:</b> Người dùng có quyền yêu cầu dừng xử lý hoặc xoá dữ liệu.
        </li>
      </ul>
      <hr />
      ...
      <p>Chúng tôi không sử dụng cookie để theo dõi quảng cáo hay bán dữ liệu cho bên thứ ba.</p>
      <hr />
      <h3>5. Chính sách hoạt động ngoại tuyến và đồng bộ</h3>
      <p>Ứng dụng PWA {appName} của chúng tôi hỗ trợ hoạt động không cần kết nối mạng:</p>
      <ul>
        <li>
          <b>Chế độ ngoại tuyến:</b> Người dùng có thể xem dữ liệu gần nhất đã lưu, ghi nhật ký
          (logs) mà không cần có kết nối mạng internet tại thời điểm sử dụng.
        </li>
        <li>
      ...
      <p>
        <b>Cảnh báo:</b> có dữ liệu chưa đồng bộ, ứng dụng sẽ thông báo rõ ràng.
      </p>
